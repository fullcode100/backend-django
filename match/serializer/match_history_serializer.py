...
from match.serializer import team_serializer,group_serializer, category_serializer
...
class MatchHistorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MatchHistory
        fields = ['id', 'team_a', 'team_b', 'is_game', 'team_a_goal', 'team_b_goal', 'stage', 'is_a_win', 'is_b_win','match_date','group','category']
